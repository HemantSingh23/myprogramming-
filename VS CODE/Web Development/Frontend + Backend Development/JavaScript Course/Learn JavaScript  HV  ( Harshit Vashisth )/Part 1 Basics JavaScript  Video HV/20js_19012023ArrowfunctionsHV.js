...
//  // if only one parameter in function then we can remove
//  // the parenthesis form the parameter in Arrow Functon
...
//  // if in the arrow function there is only one line then
...
//  // if in the arrow function there is only one line when
//  // arrow function return something then we can remove 
//  // curly braces and return  also 
